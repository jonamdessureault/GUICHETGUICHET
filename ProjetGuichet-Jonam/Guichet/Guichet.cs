    ...
    public class Guichet
    {
        ...
        public void EffectuerVirement()
        {
            ...
            if (parseSuccess)
            {
                if (compte == "1")
                {
                    ...
                    {
                        Console.WriteLine("Le montant à virer doit être supérieur à 0");
                    }
                }
                else if (compte == "2")
                {
                ...
                {
                    Console.WriteLine("Veuillez choisir un compte disponible");
                }
            }
            else
            {
        ...
        public void ChoixMenuAdmin(string choix)
        {
            switch(choix)
            {
                ...
                default: Console.WriteLine("Veuillez entrer un choix valide");
                    break;
            }
        }
